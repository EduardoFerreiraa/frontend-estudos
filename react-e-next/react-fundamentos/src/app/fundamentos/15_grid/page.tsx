export default function Aplicacao() {
    return (
        // <div className="border-2 p-3 grid grid-cols-4 gap-2">
        // <div className="border-2 p-3 grid grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        // <div className="caixa col-span-1 md:col-span-2 lg:col-span-3 xl:col-span-4">Caixa 1</div>

        <div className="border-2 p-3 h-screen grid grid-cols-4 gap-2 content-start">
            <div className="caixa col-span-1">Caixa 1</div>
